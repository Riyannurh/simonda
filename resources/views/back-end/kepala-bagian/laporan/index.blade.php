...
<div class="card mb-6" id="filterCard">
    ...
    <div id="filterBody" class="card-body">
        <form id="formFilter" method="GET" action="{{ route('kepala-bagian.laporan.index') }}">
            <div class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="{{ route('kepala-bagian.laporan.index') }}" class="btn btn-outline-secondary w-100">
...
function doExport(scope) {
    ...
    const baseUrl = currentExportType === 'excel'
        ? '{{ route("kepala-bagian.laporan.export.excel") }}'
        : '{{ route("kepala-bagian.laporan.export.pdf") }}';

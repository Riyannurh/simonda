...
<div class="info-row">
    <strong>Pendata&nbsp;&nbsp;&nbsp;:</strong> {{ $pendata ? $pendata->name : 'Semua Pendata' }}<br>
...
<table>
    <thead>
        <tr>
            ...
            <th style="width:11%">Omset/Tahun (Rp)</th>
            <th style="width:10%">Legalitas</th>
            <th style="width:10%">Pendata</th>
        </tr>
    </thead>
    <tbody>
...
<div class="footer">
    Dicetak oleh sistem SIMONDA &mdash; {{ now()->format('d/m/Y H:i') }}
</div>
